...
class squirrels(models.Model):
    Longitude= models.DecimalField(help_text='Longitude',max_length=200,max_digits=20,decimal_places=2)
    
    Latitude=models.DecimalField(help_text='Latitude',max_length=200,max_digits=20,decimal_places=2)
