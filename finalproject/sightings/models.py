...
class Sightings(models.Model):
    Longitude= models.DecimalField(help_text='Longitude', max_digits=20, decimal_places=2,)
    Latitude=models.DecimalField(help_text='Latitude',max_digits=20, decimal_places=2,)
    Unique_Squirrel_Id=models.CharField(help_text='Unique Squirrel ID',max_length=200,)
    AM,PM='AM','PM'
    Shift=models.CharField(help_text='Shift',max_length=200, choices=((AM,'am'),(PM,'pm'),),default=AM)
